...
<body>
  <h1 style="font-size: 2.5em; margin: 0.67em 0;" class="justify-content-left d-inline">ISF Chat</h1>
  ...
  <h1 style="margin: 0.67em 0; text-align: center; font-size:48px;" class="animate__animated animate__fadeIn"><?php echo "Welcome to ISF Chat, <strong>".$_SESSION['username']; ?></strong>&nbsp<i style="font-size:16px;" class='fas fa-circle align-middle text-success'></i></h1>
  ...
  <div class="modal fade fast" id="chatModal" tabindex="-1" aria-labelledby="chatModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="mb-3">
              <div id="chat-box" style="height:500px; background-image: url('../resources/images/chat-background.jpg'); border:1px solid #ddd; overflow: auto; padding:16px; margin: 25px 15px 0px 15px; border-radius:8px;"></div>
        </div>
